export default {
  ...
  aiConfig: {
    ...
    form: {
      ...
      endpointPlaceholder: 'e.g., /chat/completions',
      endpointTip: 'API endpoint path, leave empty to auto-set based on provider',
      queryEndpoint: 'Query Endpoint',
      queryEndpointPlaceholder: 'e.g., /video/task/{taskId}',
      queryEndpointTip: 'Endpoint path for async task querying (video generation, etc.)',
      apiKey: 'API Key',
  ...
  video: {
    ...
    videoMergeInDev: 'Video Merge feature in development',
