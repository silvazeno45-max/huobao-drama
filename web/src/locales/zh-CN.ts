export default {
  ...
  aiConfig: {
    ...
    form: {
      ...
      fullEndpoint: '完整调用路径',
      endpoint: 'API 端点',
      endpointPlaceholder: '例如: /chat/completions',
      endpointTip: 'API 调用路径，留空将根据厂商自动设置',
      queryEndpoint: '查询端点',
      queryEndpointPlaceholder: '例如: /video/task/{taskId}',
      queryEndpointTip: '用于异步任务查询的端点路径（视频生成等）',
      apiKey: 'API Key',
